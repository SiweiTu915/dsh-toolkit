...
>
> **This repository is where I maintain my own modifications and upgrades to DSH long-term.** New capabilities follow the structure described in 命令速查 (Chinese).
...
| 命令速查 | Command cheat-sheet (version-independent — still valid after upgrades) |
